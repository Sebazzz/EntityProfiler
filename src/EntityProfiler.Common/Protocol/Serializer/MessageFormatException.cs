namespace EntityProfiler.Common.Protocol.Serializer {
    ...
    /// <summary>
    /// Represents the exception that is thrown when a message is not in parsable format
    /// </summary>
    [Serializable]
    public class MessageFormatException : Exception {
        ...
        protected MessageFormatException([NotNull] SerializationInfo info, StreamingContext context) : base(info, context) {}
    }
}